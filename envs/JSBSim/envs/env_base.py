...
class BaseEnv(gymnasium.Env):
    ...
    def __init__(self, config_name: str, policy_type: str = 'fkr',  algorithm: str = "mappo", fix_position: bool = False):
        # basic args
        self.config = parse_config(config_name, policy_type, algorithm, fix_position)
